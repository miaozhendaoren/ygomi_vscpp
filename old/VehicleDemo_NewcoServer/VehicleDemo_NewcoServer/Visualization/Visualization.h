...
#define FRAME_NUM_PER_SECOND  20     //the frame speed per second to draw
...
#define Driver_VIEW_OFFSET          (2.5)
#define CAR_POS_OFFSET              (2.5)
...
#define MAX_BUFFER_DEPTH_DRAW_LINE_POINT 256
#define MAX_BUFFER_NUMBER_DRAW_LINE   200
...
public:
	...
	GLboolean AddOneRoadLineInfo(int number,lineTypeEnum_t type, point3DFloat_t* buffer);
