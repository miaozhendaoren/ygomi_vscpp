...
struct svm_model *cir_model = svm_load_model("./resource/svm/cir_model.txt");
struct svm_model *rec_model = svm_load_model("./resource/svm/rec_model.txt");
struct svm_model *tri_model = svm_load_model("./resource/svm/tri_model.txt");

int feat_cir[1568] = {
#include "../resource/svm/CIRfeat.txt"
};
int feat_rec[1568] = {
#include "../resource/svm/RECfeat.txt"
};
int feat_tri[1568] = {
#include "../resource/svm/TRIfeat.txt"
};
Mat image27452 = cv::imread("./resource/png/27452.png");
Mat image27453 = cv::imread("./resource/png/27453.png");
Mat image27454 = cv::imread("./resource/png/27454.png");
Mat image27455 = cv::imread("./resource/png/27455.png");
Mat image27456 = cv::imread("./resource/png/27456.png");
Mat image28300 = cv::imread("./resource/png/28300.png");
Mat image28600 = cv::imread("./resource/png/28600.png");
Mat image20600 = cv::imread("./resource/png/20600.png");
Mat image22400 = cv::imread("./resource/png/22400.png");
Mat image24000 = cv::imread("./resource/png/24000.png");
Mat image23900 = cv::imread("./resource/png/23900.png");
Mat image22220 = cv::imread("./resource/png/22220.png");
Mat image99900 = cv::imread("./resource/png/99900.png");
Mat image23700 = cv::imread("./resource/png/23700.png");
Mat image31400 = cv::imread("./resource/png/31400.png");
Mat image35010 = cv::imread("./resource/png/35010.png");
Mat image30600 = cv::imread("./resource/png/30600.png");
Mat image20500 = cv::imread("./resource/png/20500.png");
Mat image30100 = cv::imread("./resource/png/30100.png");
Mat image13100 = cv::imread("./resource/png/13100.png");	
Mat image12300 = cv::imread("./resource/png/12300.png");
Mat image13810 = cv::imread("./resource/png/13810.png");
Mat image10100 = cv::imread("./resource/png/10100.png");
Mat image13310 = cv::imread("./resource/png/13310.png");
