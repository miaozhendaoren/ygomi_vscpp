...
/**
 *	summary : calculate sum of parameters
 *	parameters :
 *		dNumarry : pointer point to parameters
...
/**
 *	summary : polynomial curve fitting
 *	parameters :
 *		dx, dy : pointer point to fitting parameters with normalized
 *		n : number of fitting parameters
 *		ex : fitting times
 *		normalization : normalized parameters
 *						normalization.x - mean(x)
 *						normalization.y - std(x)
...
/**
 *	summary : calculate mean square error of polynomial coefficients
 *	parameters :
 *		dx, dy : pointer point to fitting parameters with normalized
 *		n : number of fitting parameters
 *		coefficient : polynomial coefficients
...
/**
 *	summary : calculate polynomial value of x
 *	`		  normalize x with normalization at first, then calculate value based on coefficient
 *	parameters :
 *		x : parameters not normalized
 *		coefficient : polynomial coefficients
 *		normalization : normalized parameters
 *						normalization.x - mean(x)
 *						normalization.y - std(x)
...
/**
 *	summary : fitting parameters normalized
 *	`		  X = (x - mean(x)) / std(x)
 *	parameters :
 *		dx : pointer point to fitting parameters
 *		number : number of fitting parameters
 *		normalization : normalized parameters
 *						normalization.x - mean(x)
 *						normalization.y - std(x)
 */
