...
void messageProcessClass::setMsgHeader(uint32* msgIn,uint16 msgTypeID,uint32 vehicleID,uint16 priority,uint32 payloadLen,uint16 numPDUs,uint16 headerLen)
{
	...
	msgHeaderPtr->payloadLen = payloadLen;
