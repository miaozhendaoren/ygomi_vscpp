...
/****************************************************************************************************/
void PositCopl(nbP,imagePoints,objectPoints,objectMatrix,
               focalLength,Rot1,Trans1,Rot2,Trans2)
/*retourne les DEUX poses resultant de la convergence des deux branches de POSIT, sans les juger*/

double   **imagePoints,**objectPoints,**objectMatrix;
double   focalLength;
...
double    NU=0,I0I0,J0J0,I0J0,delta,q,lambda,mu,scale,zmin1,zmin2,zi,PI=3.1415927;
