...
#define ICP_MAX_ITER 200
#define MIN_NUM_POINT 2
...
public:
  ...
  void matchPoints (double *T,const int32_t T_num,Matrix &R,Matrix &t,const std::vector<int32_t> &active, std::vector<int32_t> &matchIdx, std::vector<int32_t> &closeIdx, double *minDist, double *meanDist);
  
private:
  
  // iterative fitting
  void fitIterate(double *T,const int32_t T_num,Matrix &R,Matrix &t,const std::vector<int32_t> &active,std::vector<int32_t> &matchIdx, std::vector<int32_t> &closeIdx, double *minDist, double *meanDist);
